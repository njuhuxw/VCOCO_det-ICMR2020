...
def show_boxes(im_path, imid, dets, cls, colors=None):
    ...
    dir = '/home/magus/dataset3/coco2014/double/'
    plt.savefig(dir +img)
            ...
            for i in test:
                ...
                if 'obj' in role_name and 'instr' in role_name:
                    ...
                    for ii in range(len(humans)):
                        ...
                        if iou_human > 0.5 and iou_object > 0.5:
                            if action_name in sort_action[:5]:
                                for mm in range(5):
                                    if action_name==sort_action[mm]:
                                        print (str(dimid) + action_name+str(mm+1))
                                        show_boxes(im_path, str(dimid) + action_name+str(mm+1), [hbox_det, obox_det],
