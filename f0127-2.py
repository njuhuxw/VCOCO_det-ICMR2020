            ...
            for t in range(len(oboxs_det)):
                    ...
                    if 'obj' in role_name and 'instr' in role_name:
                        ...
                        for ii in range(len(humans)):
                            ...
                            if iou_human > 0.5:
                                ...
                                # show_boxes(im_path, str(dimid) + action_name+str(sum), [hbox_det, [0,0,0,0]],
                                #                [vrbs, ''],
                                #                ['red', 'blue'])
                                flag=1
                ...
                if len(verbb) > 0 :
                    for o in iou_cls_obj:
                        if len(o)>0:
                            show_boxes(im_path, str(dimid) +vrbs+str(sum), [hbox_det, obox_det], [vrbs, o],
                                               ['red', '#00B0F0'])
                            flag=1
                            break

                elif vrbs=='stand' or vrbs=='run' or vrbs=='walk' or vrbs=='smaile':
                    show_boxes(im_path, str(dimid) + action_name+str(sum), [hbox_det, [0,0,0,0]],[vrbs, ''],['red', 'blue'])



            if flag==0:
                show_boxes(im_path, str(dimid)  + 'sum:'+str(sum)+'m', [hbox_det, [0,0,0,0]], ['stand', ''],
                       ['red', '#00B0F0'])
