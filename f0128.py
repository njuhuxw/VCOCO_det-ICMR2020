...
if __name__ == '__main__':
    ...
    # S=[146120,196989,213247,213403,229388,246105,253967,253969,295194,391179,442836,450845,524459]
    S1=[391179]
                    ...
                    for i in test:  # test is action
                        ...
                        if 'obj' in role_name and 'instr' in role_name:
                            ...
                            for ii in range(len(humans)):
                                ...
                                if iou_human > 0.5 and iou_object > 0.5 and len(cls_obj[ii]) > 0.5:
                                    sum += 1
