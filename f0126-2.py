...
def show_boxes(im_path, imid, f_dets, f_cls, colors=None):
    ...
    plt.margins(0, 0)
    dir = '/home/magus/dataset3/coco2014/t0126-3/'
...
if __name__ == '__main__':
    ...
    # S=[68674,69544,70256,79113,81738,86147,100624,104221,110392,114453,201637]
    # S=[133291,145408,227855,263586,468577,110392,131494,237618,557965,330699,79113,116377]
    # S=[79113,145408,227855,263586]
    # S=[133291,181013,145408,131494,328,116377,557965]
    S = [181013]
    f_hb = []
    f_ob = []
    f_v = []
                ...
                if len(verbb) > 0:
                    for o in iou_cls_obj:
                        if len(o) > 0:
                            ...
                            f_v.append(vrbs)
                            f_o.append(o)
                            # show_boxes(im_path, str(dimid)+'-'+str(t), [hbox_det, obox_det], [vrbs, o],
                            #                    ['red', '#00B0F0'])
                            break

            show_boxes(im_path, str(dimid), [f_hb, f_ob], [f_v, f_o],
                       ['red', '#00B0F0'])

            # for i in range(len(f_hb)):
            #     print (len(f_hb))
            #     if i==0:
            #         show_boxes(im_path, str(dimid), [f_hb[i], f_ob[i]], [f_v[i], f_o[i]],
            #            ['red', '#00B0F0'])
            #         print (im_path)
            #
            #     else :
            #         im_path='/home/magus/dataset3/coco2014/t0126-3/'+str(dimid)+'.png'
            #         show_boxes(im_path, str(dimid), [f_hb[i], f_ob[i]], [f_v[i], f_o[i]],
            #                    ['red', '#00B0F0'])
            #         print (im_path)
